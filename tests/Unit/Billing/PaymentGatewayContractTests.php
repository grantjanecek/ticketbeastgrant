...
trait PaymentGatewayContractTests
{
    ...
    public function charges_with_a_valid_payment_token_are_successful()
    {
        ...
        $newCharges = $paymentGateway->newChargesDuring(
            fn ($paymentGateway) => $paymentGateway->charge(2500, $paymentGateway->getValidTestToken())
        );
    ...
    public function can_fetch_charges_created_during_a_callback()
    {
        ...
        $paymentGateway->charge(4500, $paymentGateway->getValidTestToken());
        ...
        $this->assertEquals([2000, 4000], $newCharges->map->amount()->all());
    }
}
