<x-promoter-layout>
    <div class="container mx-auto py-5">
        <div class="flex align-baseline justify-between bg-white">
            <p class="text-xl">New Concert</p>
                            ...
                            <div class="flex space-x-10">
                                <div class="w-1/2">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="ticket_price" id="ticket_price" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="0.00" aria-describedby="price-currency">
                                ...
                                <div class="w-1/2">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="ticket_quantity" id="ticket_quantity" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="250">
                                    </div>
                                </div>
                            </div>
                        </div>
